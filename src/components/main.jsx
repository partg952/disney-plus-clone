...
export default function Main() {
  ...
  return (
    <div style={{
      ...
      <Viewers>
        <div>
          <video src={MarvelVideo} loop={true} autoPlay={true} muted></video>
          <br/>
          <img src={MarvelImage} alt=""/>
        </div>
        <div>
          <video src={PixarVideo} autoPlay={true} loop={true} muted></video>
          <br/>
          <img src={PixarImage} alt=""/>
        </div>
        <div>
          <video src={StarWarsVideo} autoPlay={true} loop={true} muted></video>
          <br/>
          <img src={StarsWarsImage} alt=""/>
        </div>
        <div>
          <video src={NationalVideo} autoPlay={true} loop={true} muted></video>
          <br/>
          <img src={NationalImage} alt=""/>
        </div>
        <div>
          <video src={DisneyVideo} muted autoPlay={true} loop={true}></video>
          <br/>
      ...
      <Originals url={`/discover/movie?api_key=${api_key}&with_genres=35`}/> {/* <Background/> */}
    </div>
  )
}
